...
//
// compose() below is superseded: since migration 055 this check is one of
// four sections in lib/nightlyEmail.js, which names the child, age and room
// in the email itself rather than pointing at a login — the owner's ruling
// of 16 September 2026, reversing the counts-only decision ec793da and 037
// made here. dayMonth() and recipients() are still what jobs.js and
// lib/nightlyEmail.js use; compose() stays only as the shape the newer file
// was built from.
//
