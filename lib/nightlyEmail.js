...
// outbound mail and this email keeps to that; the 22:00 alert
// (lib/guardianAlert.js) is the one exception and says why. Every name is
// one tap away, behind the login, on a view the app records.
//
...
// something in it ("Open Families"); `count` and `link` name the keys the
// caller passes.
const SECTIONS = Object.freeze([
  { count: 'guardian_gaps', link: 'families',  label: 'Children on site without a guardian',          open: 'Families' },
