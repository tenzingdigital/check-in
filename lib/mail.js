...
/* ---------------------------------------------------------------------------
   ...
   `{ label, value, lines }` renders as its own bordered block, the label and
   value as a heading row and `lines` — one bullet per string — beneath it,
   after `rows` and before the CTA. A section with no lines renders nothing,
