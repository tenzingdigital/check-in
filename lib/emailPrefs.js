...
// The profiles columns the given kinds read, once each: four kinds share
// safeguarding_alert (054) — the 22:00 alert, the nightly email and the two
// retired kinds — and "stop all" names the two current ones, so the same
