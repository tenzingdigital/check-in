...
// went, and stopping the old alert's kind clears the same tick the nightly
// email reads, so the old link still does what the person meant by it.
const KINDS = Object.freeze({
  ...
  house_rules:        Object.freeze({ name: 'the nightly House Rules reminder (now the nightly email)',     tick: null }),
});
