...
const KINDS = Object.freeze({
  ...
  safeguarding_alert: Object.freeze({ name: 'the nightly safeguarding alert',   tick: 'safeguarding_alert' }),
  house_rules:        Object.freeze({ name: 'the nightly House Rules reminder', tick: null }),
});
...
module.exports = { KINDS, isKind, urlFor, headersFor, slugForSchema, slugForUser, keyFor, linkFor, optOut, optIn, optOutsFor };
