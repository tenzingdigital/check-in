...
// rooms and dates — attached by default since migration 055, unless the
// centre has turned that off; migration 052 added the switch).
...
// email"). The names are in the attached document instead — on by default
// since 055, unless the centre has turned that off — see document() below.
// rows only ever contributes numbers
