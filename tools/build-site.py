...
body = (
  ...
  sec("""    <h2>What your staff see</h2>
    ...
    <p>Where a centre lets adults record their own presence, a self check-in tablet by the door opens on a photograph of your own centre and speaks the residents' languages — a room code or a name finds them, and each check-in is marked as made at the tablet.</p>
    <div class="pairs">
